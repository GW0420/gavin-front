<template>
  <div class="group relative p-0.5 rounded-xl border-white duration-500 hover:bg-red-100/40">
    <div>
      <!-- 搜索图标 -->
      <gw-svgicon class="w-1.5 h-1.5 absolute translate-y-[-50%] top-[50%] left-2" name="search" color="#707070" />
      <!-- 输入框 -->
      <input
      ...
      ></div>
      <!-- TODO: 搜索按钮(通用组件) -->
      <gw-button class="absolute translate-y-[-50%] top-[50%] right-1" icon="search" iconColor="#ffffff"></gw-button>
    </div>
    <!-- 下拉区 -->
